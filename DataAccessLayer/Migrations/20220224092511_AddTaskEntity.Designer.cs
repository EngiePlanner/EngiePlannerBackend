...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220224092511_AddTaskEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObjectLayer.Entities.DeliveryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessObjectLayer.Entities.TaskEnitity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessObjectLayer.Entities.TaskEnitity", b =>
                {
                    b.HasOne("BusinessObjectLayer.Entities.DeliveryEntity", "Delivery")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessObjectLayer.Entities.UserTaskMapping", b =>
                {
                    b.HasOne("BusinessObjectLayer.Entities.TaskEnitity", "Task")
                        .WithMany("Employees")
